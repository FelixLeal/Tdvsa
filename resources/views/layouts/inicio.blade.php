...
<html lang="en">
	...
	<body id="principal">
		<div class="large-2 columns" id="panel_izq" >
			<div class="large-12 columns" style="background-color: #3B4C54; padding-top: 15px; padding-bottom: 15px;">
				<!--img src="img/logo-tdvsa-med.png"-->
				<img src="{{ asset('/img/logo-tdvsa-med.png') }}">
			</div>
			<div class="large-12 columns" id="items_izq" style="padding-top: 0px;">
