...
@section('contentInicio')
    ...
    <div class="report perfil large-12 columns">
        ...
        {!! Form::open( ['route' => 'perfil.update', 'id' => 'form_2', 'class' => 'large-12' ] ) !!}
            ...
            <div class="large-12 columns campos">
                ...
                <div class="labelReal">{!! Form::text('telf_persona', $empresa->telf_persona) !!}</div>
            </div>
            ...
            <div class="large-12 columns campos">
                ...
                <div class="labelReal">{!! Form::text('email_empresa', $empresa->email_empresa) !!}</div>
            </div>
            
            <div class="large-12 columns campos">
                {!! Form::label('direccion', 'Direccion:') !!}
                <div class="labelReal">{!! Form::text('direccion', $empresa->direccion) !!}</div>
            </div>
            
            <div class="large-12 columns campos">
                {!! Form::label('telf_empresa', 'Telefono:') !!}
                <div class="labelReal">{!! Form::text('telf_empresa', $empresa->telf_empresa) !!}</div>
            </div>
            ...
            <div class="large-12 columns campos">
                ...
                <div class="labelReal">{!! Form::text('name', $user->name) !!}</div>
            </div>

            <div class="large-12 columns campos">
                {!! Form::label('email', 'Correo Electronico:') !!}
                <div class="labelReal">{!! Form::text('email', $user->email) !!}</div>
            </div>
